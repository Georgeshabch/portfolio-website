...
export const metadata: Metadata = {
  title: "George Habchi",
  description: "George is a full-stack developer with 1 year of experience",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className="relative bg-gray-50 pt-28 text-gray-950 transition-all sm:pt-36"
      >
        <div
          className="absolute right-[11rem] top-[-6rem] -z-10 h-[31.25rem] w-[31.25rem] 
          rounded-full bg-[#946263] blur-[10rem] dark:bg-[#fbe2e3] sm:w-[68.75rem]"
        />
        <div
          className="absolute left-[-35rem] top-[-1rem] -z-10 h-[31.25rem] w-[50rem] 
          rounded-full bg-[#676394] blur-[10rem] dark:bg-[#dbd7fb] sm:left-[-30rem] 
