    ...
    return (
        <section className='mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]' ref={ref} id='home'>
            <div className='flex items-center justify-center'>
                <div className='relative'>
                    <motion.div
                        ...
                        <img src='https://media.licdn.com/dms/image/v2/D4D03AQE2N2ZezB3g9Q/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1702888813040?e=2147483647&v=beta&t=mbcvAOaZwp_GEGg7qX5h2At6Ee-Qj8vVaPAeFUTuZf0'
                            alt='George Habchi'
                            width="192"
                            height="192"
            ...
            <motion.h1 className='mb-10 mt-4 px-4 text-2xl font-medium !leading-[1.5] sm:text-3xl'
                ...
                <span className='font-bold'>Hello, I'am George Habchi.</span> I'am a{" "}
            ...
            <motion.div className='flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium'
                ...
                <a className='group bg-white px-5 py-2  flex items-center gap-2 rounded-full
                ...
                <a className='bg-white p-4 text-blue-800 flex items-center gap-2 rounded-full
                              focus:scale-[1.15] hover:text-blue-900 hover:scale-110 active:scale-105 transition cursor-pointer border
                              border-black/10'
                    href='https://www.linkedin.com/in/georges-habchi-6a541821b/' target='_blank'>
                    <BsLinkedin /> </a>
                <a className='bg-white p-4 flex items-center font-bold gap-2 rounded-full
                              focus:scale-[1.15] hover:text-pink-700 hover:scale-110 active:scale-105 transition cursor-pointer border
                              border-black/10'
                    href='https://www.instagram.com/georgestricks/' target='_blank'>
                    <BsInstagram className='text-pink-600' /></a>
